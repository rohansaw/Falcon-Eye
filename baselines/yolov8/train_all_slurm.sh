...
#CONVERSION_CONFIG_FILES=("/yolov8/conversion_configs/sds.sh" "/yolov8/conversion_configs/sw.sh" "/yolov8/conversion_configs/sds_sliced.sh" "/yolov8/conversion_configs/sw_sliced.sh")
CONVERSION_CONFIG_FILES=("/yolov8/conversion_configs/sds_sliced.sh")
