...
class Metrics:
    def __init__(self, scale_factor, tolerance, treshold, classes, sizes=default_sizes):
        self.scale_factor = scale_factor
        self.tolerance = tolerance
        self.treshold = treshold
        self.classes = classes # tupled ("class_name", class_id)
        self.sizes = (
    ...
    def tp_fp_tn_fn(self, logits_grid, y_true):
        ...
        for class_id in range(1, preds_grid.shape[0]):
            ...
            self.tp_fp_tn_fn_counts["FP"] += fp_mask.sum().item()
