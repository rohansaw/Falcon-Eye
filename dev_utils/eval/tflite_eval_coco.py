...
def postprocess_results(output_data, image_id, category_id=1, score_threshold=0.5, iou_threshold=0.5):
    scores = output_data[0][0]
    boxes = output_data[1][0]
    cat_ids = output_data[3][0]
...
if __name__ == "__main__":
    model_path = "/scratch1/rsawahn/results/all_best/int8-sw-sliced-efficientdet.tflite"
